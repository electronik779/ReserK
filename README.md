...
### Windows
Для Windows x64 скачайте "свежий" (Latest) релиз [Setup_ReserK_vXXXX.X_Win.exe](https://github.com/electronik779/ReserK/releases) и установите, выбрав опцию "для всех пользователей".
...
Результаты расчета, показываются на графиках справа. Под графиками выводятся значения объема верхней камеры и максимального уровня (при определении максимального уровня) и минимального уровня в резервуаре (при определении минимального уровня).
